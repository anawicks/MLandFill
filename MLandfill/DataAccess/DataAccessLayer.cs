...
namespace MLandfill.DataAccess
{
    ...
    public class DataAccessLayer
    {
        ...
        public IEnumerable<DocketGrid> docketsGridGet()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("spDocketGridGet", con))
                {
         ...
         
        {
            ...
            using (con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataAccessCn"].ToString()))
            {
                using (SqlCommand cmd = new SqlCommand("spDocketWasteGet", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void DocketUpdate(DocketViewModel docket)
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("spDocketWasteUpdate", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public IEnumerable<ModelDockets> docketsAllGet()
        {
            ...
            try
            {
                using (con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataAccessCn"].ToString()))
                {
                    using (SqlCommand cmd = new SqlCommand("spDocketWasteGetAll", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        con.Open();
                        using (SqlDataReader rdr = cmd.ExecuteReader())
       ...
       public void DocketDelete(int docketId)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("spDocketWasteDelete", con))
                {
                    try
                    {
                        cmd.Parameters.Clear();
        ...
        public IEnumerable<InvoiceDocket> InvoiceDocketsGet(int generatorId, string month, int year, string approvalCode)
        {
            ...
            try
            {
                using (con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataAccessCn"].ToString()))
                {
                    using (SqlCommand cmd = new SqlCommand("InvoiceOfDocketsGet", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public IEnumerable<tblGenerator> InvoiceGeneratosGet(string month, int year)
        {
            ...
            try
            {
                ...
                using (con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataAccessCn"].ToString()))
                {
                    using (SqlCommand cmd = new SqlCommand("InvoiceGeneratorsGet", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@Month", month);
                        cmd.Parameters.AddWithValue("@Year", year);
        ...
        public IEnumerable<tblLandFillWasteDocket> InvoiceWasteAppCodesGet(int generatorId, string month, int year)
        {
            ...
            try
            {
                using (con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataAccessCn"].ToString()))
                {
                    using (SqlCommand cmd = new SqlCommand("InvoiceApprovalCodeGet", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@GeneratorId", generatorId);
                        cmd.Parameters.AddWithValue("@Month", month);
        ...
        private string SubstanceCodeGet(int substanceId)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("spSubstanceCodeGet", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int NewInvoiceNoGet( int month, int year, int generatorId, string approvalCode)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("spInvoiceMainSet", con))
                    {
        ...
        public IEnumerable<InvoiceBatchGrid> InvoiceBatchGridGet(string month, int year)
        {
            ...
            try
            {
                using (con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataAccessCn"].ToString()))
                {
                    using (SqlCommand cmd = new SqlCommand("spInvoiceBatchGet", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@month", month);
                        cmd.Parameters.AddWithValue("@year", year);
        ...
        public void approvalCodeDelete(int ApprovalId)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("spWasteApprovalDelete", con))
                {
                    try
                    {
                        cmd.Parameters.Clear();
                        ...
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@WApApprovalId", ApprovalId);
        ...
        public IEnumerable<tblMaintWasteApCode> WasteApprovalCodeAllGet()
        {
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["DataAccessCn"].ToString());
            SqlCommand cmd = new SqlCommand("spWasteApprovalGridGet", con);
            cmd.CommandType = CommandType.StoredProcedure;
            con.Open();
            SqlDataReader rdr = cmd.ExecuteReader();
            while (rdr.Read())
        ...
        public IEnumerable<tblMaintWasteApCode> WasteAppCodeSingleGet(int Id)
        {
            ...
            while (rdr.Read())
            {
                ...
                wasteCode.InvoiceeName = rdr["InvName"].ToString();
        ...
        public int ApprovalCodeIdNextGet()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("spWasteApprovalIndentGet", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@newIDOut", SqlDbType.Int);
                    cmd.Parameters["@newIDOut"].Direction = ParameterDirection.Output;

                    con.Open();

                    cmd.ExecuteNonQuery();
                    identCurrent = Convert.ToInt32(cmd.Parameters["@newIDOut"].Value);
                }
